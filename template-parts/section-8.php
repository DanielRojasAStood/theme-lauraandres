...
$places = [
    "hotels" => [
        ...
        "title" => "HOTELES",
        "title_es" => "Hoteles",
        "img" => IMG_BASE . 'slick-images/img-1.png',
        "places" => [
            [
                "name" => "SOFITEL LEGEND\nSANTA CLARA",
    ...
    "restaurants" => [
        ...
        "img" => IMG_BASE . 'slick-images/img-2.png',
        "places" => [
            [
                "name" => "CANDÉ",
    ...
    "brunchdesserts" => [
        "id" => "postres",
        "title" => "BRUNCH & POSTRES",
        "title_es" => "Postres y Brunch",
        "img" => IMG_BASE . 'slick-images/img-3.png',
        "places" => [
            [
                "name" => "MILA\nPASTELERÍA",
    ...
    "bares" => [
        ...
        "title" => "BARES",
        "title_es" => "Bares",
        "img" => IMG_BASE . 'slick-images/img-4.png',
        "places" => [
            [
                "name" => "ALQUÍMICO",
            ...
            [
                ...
                "link" => "https://www.instagram.com/lajugadaclubhouse/",
            ],
            [
                "name" => "BUENA VIDA",
    ...
    "boutiques" => [
        ...
        "img" => IMG_BASE . 'slick-images/img-5.png',
        "places" => [
            [
    ...
    "beautysalons" => [
        ...
        "img" => IMG_BASE . 'slick-images/img-6.png',
        "places" => [
            [
                "name" => "PORTADA\nPELUQUERÍA",
                "address" => "Calle 38 # 8 - 19",
...
<section class="sectionPlaces">
    <div class="sectionPlaces__container">
        <?php foreach ($places as $category) { ?>
            <div class="sectionPlaces__title" id="<?php echo $category['id']; ?>">
